...
MODEL_CONFIGS = {
    ...
    "pythia-160m": {"batch_size": 512, "dtype": "float32", "layers": [8], "d_model": 768},
...
def run_evals(
    ...
    output_folders: dict = output_folders,
):
    ...
    eval_runners = {
        ...
        "scr": (
            lambda: scr_and_tpp.run_eval(
                ...
                selected_saes,
                device,
                output_folders["scr"],  # We add scr or tpp depending on perform_scr
                force_rerun,
        ...
        "tpp": (
            lambda: scr_and_tpp.run_eval(
                ...
                selected_saes,
                device,
                output_folders["tpp"],  # We add scr or tpp depending on perform_scr
                force_rerun,
                clean_up_activations=True,
                save_activations=save_activations,
            )
