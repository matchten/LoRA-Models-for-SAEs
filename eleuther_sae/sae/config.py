...
class TrainConfig(Serializable):
    ...
    e2e: bool = False
    """Use KL divergence as the loss function."""

    initialize_sae: str | None = None
    """Path to a saved SAE to initialize the model with."""

    model_lr: float | None = None
    """Base LR for the language model. If None, it is automatically chosen based on the number of latents."""
